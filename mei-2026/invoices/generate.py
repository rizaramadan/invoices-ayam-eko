...
customers = [
    ...
    (3,  "Nabila", [("Ayam Panggang", 1, 140000), ("Char Siu Ayam", 1, 140000), ("Chilli Oil Botol", 1, 25000), ("Hoisim Sauce", 2, 15000)]),
    (4,  "Andona", [("Ayam Klungkung", 3, 100000), ("Chilli Oil 100gr", 2, 15000), ("Sambel Bodo", 3, 0)]),
    (5,  "Ajeng",  [("Ayam Panggang", 1, 140000), ("Chilli Oil Botol", 1, 25000)]),
    ...
    (8,  "Yanti",  [("Ayam Panggang", 1, 140000), ("Chilli Oil Botol", 1, 25000)]),
    (9,  "Sahara", [("Ayam Rebus", 2, 140000), ("Bebek Panggang", 0.5, 300000)]),
    (10, "Femi",   [("Ayam Rebus", 1, 140000), ("Ayam Klungkung", 1, 100000), ("Chilli Oil Botol", 1, 25000), ("Sambel Bali", 1, 0)]),
    (11, "Mitha",  [("Ayam Rebus", 1, 140000), ("Ayam Klungkung", 1, 100000), ("Sambel Bodo", 1, 0)]),
    (12, "Silmi",  [("Ayam Rebus", 1, 140000), ("Chilli Oil 100gr", 2, 15000), ("Sambel Bodo (extra)", 1, 15000)]),
