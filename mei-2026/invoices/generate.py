...
customers = [
    ...
    (3,  "Nabila", [("Ayam Panggang", 1, 140000), ("Char Siu Ayam", 1, 140000), ("Chilli Oil Botol", 1, 15000), ("Hoisim Sauce", 2, 15000), ("Bebek Goreng", 1, 150000)]),
    (4,  "Andona", [("Ayam Klungkung", 3, 100000), ("Chilli Oil 100gr", 2, 15000), ("Sambel Bodo (gratis)", 3, 0)]),
    (5,  "Ajeng",  [("Ayam Panggang", 1, 140000), ("Chilli Oil Botol", 1, 15000), ("Bebek Goreng", 1, 150000)]),
    ...
    (10, "Femi",   [("Ayam Rebus", 1, 140000), ("Ayam Klungkung", 1, 100000), ("Chilli Oil Botol", 1, 15000), ("Burung Puyuh", 1, 50000)]),
    (11, "Mitha",  [("Ayam Rebus", 1, 140000), ("Ayam Klungkung", 1, 100000), ("Bebek Goreng", 1, 150000)]),
